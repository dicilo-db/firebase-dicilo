          ...
          <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            ...
            <Link href="/admin/ai-chat" className="group">
              <Card className="h-full bg-indigo-50/50 dark:bg-indigo-900/10 border-indigo-200 transition-all hover:shadow-md hover:border-indigo-500 cursor-pointer relative">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium text-indigo-700 dark:text-indigo-400">KI del agente de dicibot</CardTitle>
                  <Bot className="h-4 w-4 text-indigo-500 group-hover:scale-110 transition-transform" />
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold">Base de Conocimientos</div>
                  <p className="text-xs text-muted-foreground mt-1">Gestión de 100 preguntas y FAQs</p>
                </CardContent>
              </Card>
            </Link>
            ...
            {/* Profile Reminders */}
            <Link href="/admin/profile-reminders" className="group">
              <Card className="h-full bg-orange-50/50 dark:bg-orange-900/10 border-orange-200 transition-all hover:shadow-md hover:border-orange-500 cursor-pointer relative">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-bold text-orange-700 dark:text-orange-400">Seguimiento</CardTitle>
                  <AlertCircle className="h-4 w-4 text-orange-500 group-hover:scale-110 transition-transform" />
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-black">Perfiles Incompletos</div>
                  <p className="text-xs text-muted-foreground mt-1">Estado y recordatorios manuales</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link href="/admin/coupons" className="group">
              <Card className="h-full bg-emerald-50/50 dark:bg-emerald-900/10 border-emerald-200 transition-all hover:shadow-md hover:border-emerald-500 cursor-pointer relative">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium text-emerald-700 dark:text-emerald-400">Cupones</CardTitle>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Gestión de cupones activos</p>
                </CardContent>
              </Card>
            </Link>
            ...
            <Link href="/admin/mlm" className="group">
              <Card className="h-full bg-orange-50/50 dark:bg-orange-900/10 border-orange-200 transition-all hover:shadow-md hover:border-orange-500 cursor-pointer relative">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium text-orange-700 dark:text-orange-400">Red Dicilo</CardTitle>
                  <Users className="h-4 w-4 text-orange-500 group-hover:scale-110 transition-transform" />
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold">Red Dicilo</div>
            ...
            {/* B2B Profiles (Nuevo) */}
            <Link href="/admin/b2b-profiles" className="group">
              <Card className="h-full bg-emerald-50/50 dark:bg-emerald-900/10 border-emerald-200 transition-all hover:shadow-md hover:border-emerald-500 cursor-pointer relative">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                  <CardTitle className="text-sm font-medium text-emerald-700 dark:text-emerald-400">Nuevo Ecosistema B2B</CardTitle>
                  <Building2 className="h-4 w-4 text-emerald-500 group-hover:scale-110 transition-transform" />
                </CardHeader>
                <CardContent>
                  <div className="text-2xl font-bold">Empresas Migradas</div>
                  <p className="text-xs text-emerald-600 dark:text-emerald-300 mt-1">Lista de clientes en business_profiles</p>
                </CardContent>
              </Card>
            </Link>
