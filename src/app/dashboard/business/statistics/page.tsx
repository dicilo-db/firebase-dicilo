        ...
        return (
            <div className="p-8 max-w-6xl mx-auto space-y-8">
                <div className="bg-amber-50 border border-amber-200 text-amber-800 p-4 rounded-lg flex items-start gap-4 text-sm font-medium mt-6">
                    ...
                    <p>{t('business.statistics.planReq', 'El módulo de Estadísticas Avanzadas requiere un plan Retailer o Premium. Sube de plan para analizar el rendimiento de tu audiencia en detalle.')}</p>
                </div>
            </div>
        );
    }
        ...
        <div className="p-8 max-w-6xl mx-auto space-y-8 animate-in fade-in zoom-in duration-500">
            <div className="pb-4 border-b border-slate-200 text-left">
                <h1 className="text-3xl font-bold tracking-tight text-slate-900 flex items-center gap-2">
                    ...
                    {t('business.statistics.title', 'Estadísticas')} <span className="text-blue-600">Dicilo</span>
                </h1>
                <p className="text-slate-500 mt-2 text-lg">{t('business.statistics.desc', 'Mide el impacto de tu negocio y revisa las métricas de clics, vistas de anuncios y demografía local.')}</p>
            </div>
