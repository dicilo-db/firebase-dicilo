    ...
    return (
        <div className="p-8 max-w-5xl animate-in fade-in zoom-in duration-500">
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                        ...
                        <p className="mt-3 text-stone-300 max-w-xl text-lg">
                            Crea textos persuasivos al instante. Deja que nuestro motor de Inteligencia Artificial redacte descripciones irresistibles para tus productos y anuncios publicitarios.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-16 text-center border border-stone-200 shadow-sm">
                ...
                <h2 className="text-2xl font-bold text-stone-900 mb-2">Generador Automático de Textos</h2>
                <p className="text-stone-500 max-w-lg mx-auto">
                    Con tu suscripción Premium, solo tendrás que ingresar las características de tu producto y la I.A. te devolverá un copy de ventas perfectamente optimizado para captar clientes en Dicilo.
                </p>
                <div className="mt-6 px-6 py-2 bg-stone-100 text-stone-500 font-bold rounded-full inline-block">
                    Motor I.A. en Preparación
                </div>
            </div>
        </div>
    );
