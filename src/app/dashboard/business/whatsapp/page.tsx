                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    <div>
                        <h1 className="text-3xl font-extrabold flex items-center gap-3">
                            ...
                            Bandeja Omnicanal (WhatsApp & Telegram)
                        </h1>
                        <p className="mt-3 text-emerald-100 max-w-xl text-lg">
                            Centraliza los mensajes de tus clientes. Responde desde un solo lugar o configura tu propio bot de auto-respuesta 24/7.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                ...
                <div className="bg-white rounded-2xl p-8 text-center border shadow-sm flex flex-col justify-between">
                    <div>
                        ...
                        <h2 className="text-xl font-bold text-slate-800 mb-2">Bandeja Centralizada</h2>
                        <p className="text-slate-500 mb-6 text-sm">
                            Unifica tus conversaciones de WhatsApp API, Instagram y Facebook Messenger. Responde todo desde un solo entorno al estilo Mateo.
                        </p>
                    </div>
                    <div>
                        <button className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-xl transition-colors flex items-center justify-center gap-2 mx-auto w-full">
                            <MessageCircle className="w-4 h-4" /> Abrir Inbox Multi-red
                        </button>
                        <p className="text-xs text-slate-400 mt-4 font-bold uppercase tracking-wider">Integración en curso</p>
                    </div>
                </div>
                ...
                <div className="bg-white rounded-2xl p-8 text-center border shadow-sm flex flex-col justify-between">
                    <div>
                        ...
                        <h2 className="text-xl font-bold text-slate-800 mb-2">Asignación al Equipo</h2>
                        <p className="text-slate-500 mb-6 text-sm">
                            Asigna chats específicos a diferentes miembros de tu equipo. Coordina internamente de forma invisible para el cliente.
                        </p>
                    </div>
                    <div>
                        ...
                        <p className="text-xs text-slate-400 mt-4 font-bold uppercase tracking-wider">En Preparación</p>
                    </div>
                </div>
                 ...
                 <div className="bg-white rounded-2xl p-8 text-center border shadow-sm flex flex-col justify-between">
                    <div>
                        ...
                        <h2 className="text-xl font-bold text-slate-800 mb-2">Cosechadora de Reseñas</h2>
                        <p className="text-slate-500 mb-6 text-sm">
                            Configura el bot para enviar plantillas automatizadas invitando al cliente a dejarte 5 estrellas en tu Ficha cuando un chat se cierra.
                        </p>
                    </div>
                    <div>
                        <button className="bg-amber-500 hover:bg-amber-600 text-white font-bold py-2 px-6 rounded-xl transition-colors flex items-center justify-center gap-2 mx-auto w-full">
                            Campañas de Feedback
                        </button>
                        <p className="text-xs text-slate-400 mt-4 font-bold uppercase tracking-wider">Próximamente</p>
                    </div>
                </div>
            </div>
        </div>
