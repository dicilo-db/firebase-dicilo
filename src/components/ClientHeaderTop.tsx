...
interface ClientHeaderTopProps {
  ...
  clientId?: string; // New prop for UGC
}

import { UGCRecommendationModal } from './UGCRecommendationModal';
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-6 rounded-lg p-8 shadow-sm md:flex-row">
      <div className="z-10 flex w-full flex-col justify-between gap-6 md:flex-row md:items-center">
        ...
        {/* Action Buttons & Header Graphic */}
        <div className="flex items-center gap-4">
          {clientId && (
            <div className="z-20">
              <UGCRecommendationModal businessId={clientId} businessName={clientName} />
            </div>
          )}
